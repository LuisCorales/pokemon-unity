...
public class PokemonBase : ScriptableObject
{
    ...
    //This way of writing a property works when you only want the getter
...
public enum Stat
{
    ...
    //Not actual stats, but they can be boosted
    Accuracy,
    Evasion
}
...
public class TypeChart
{
    ...
    {   
        ...
        /*PSY*/ new float[] {1f,    1f,    1f,    1f,    1f,    1f,    2f,    2f,    1f,    1f,    1f,    0.5f,  1f,    1f,    1f,    0f,    0.5f,  1f  },
        ...
        /*DRA*/ new float[] {1f,    1f,    1f,    1f,    1f,    1f,    1f,    1f,    1f,    1f,    1f,    1f,    1f,    1f,    1f,    2f,    0.5f,  0f  },
