    ...
    {
        {
            ...
            new Condition()
            {
                ...
                OnAfterTurn = (Pokemon pokemon) =>
                {
                    ...
                    pokemon.StatusChanges.Enqueue($"{pokemon.Base.Name} has been hurt due to poison.");
                }
            }
        },
        {
            ...
            new Condition()
            {
                ...
                { 
                    ...
                    pokemon.StatusChanges.Enqueue($"{pokemon.Base.Name} has been hurt due to burn.");
                }
            }
        },
        {
        ...
        },
        {
            ...
            new Condition()
            {
                ...
                OnBeforeMove = (Pokemon pokemon) =>
                {
                    ...
                    {
                        pokemon.CureStatus();
                        pokemon.StatusChanges.Enqueue($"{pokemon.Base.Name}'s longer frozen.");
                        return true;
                    }
        ...
        },
        {
            ...
            new Condition()
            {
                ...
                OnBeforeMove = (Pokemon pokemon) =>
                {
                    //If the status time has passed, then cure status
                    ...
                    //Each turn it will decrement the time the status will cure itself
                    pokemon.StatusTime--;
